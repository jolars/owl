---
title: "Regularization penalties in prague"
author: "Johan Larsson"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
bibliography: prague.bib
vignette: >
  %\VignetteIndexEntry{Regularization penalties in prague}
...
for (i in seq_along(q)) {
  ...
  p <- n/2
  sigma <- 1
  problem <- prague:::randomProblem(n, p, q = q[i], sigma = sigma)
  ...
  selected_golem <- which(abs(coef(fit)) > 0)
